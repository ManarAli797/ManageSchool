...
<body class="information">
  ...
  <ul>
    ...
    <a href="shomwork.php" ><li class="active"> الواجب البيتي  </li></a>
   ...
   <?php
            ...
            if ($result->num_rows > 0) {
              ...
              <div class="work" style="position:relative; top:150px;right:180px;">
                 <img src='../img/exam.jpg' width="37"style="position:relative;float:right;top:-40px;">
                     <h2  id="id_head"><?php echo $row["name"]; ?> </h2>
                     <p id="id_date"><?php echo date('h:m:Y', $datee); ?> </p>
                     <p id="id_cont"><?php echo $row["content"]; ?></p>
                     <p style="font-size:18px;position:relative;top:85px;right:-254px;display:inline;"> ----------------------- </p>
                  </div>
                  <?php
                }
            } else {
               echo "<p style='color:#e64673;font-size:30px;text-align:center;margin-top:200px'>لا يوجد واجب اليوم </p>";
            }
            $conn->close();
            ?>
