...
<body class="information">
  ...
  <div class="add_list">
    ...
    <ul>
      ...
      <a href="addwork.php" ><li class="active"> أضافة واجب  </li></a>
  ...
  <div  style="background:linear-gradient(45deg, #e60073,#6699ff);margin-top: 0px;
    width:520px; height:334px;position:relative;top:160px;margin-left:auto;margin-right:auto; padding:40px;">
    
    <form action="paddwork.php" method="POST" enctype="multipart/form-data">      
       <select name="namesubject"
       style="padding-bottom:10px;padding-top:10px; width:210px ;position: relative;top:5px; left:5px">
       ...
       style="width:210px;padding-bottom:10px;padding-top:10px;position: relative;top: 5px; left:90px">

        <textarea rows="13" cols="52" name="content"   
       style="padding-bottom:10px;padding-top:10px;position: relative; top: 37px; left:80px">
       ادخل  نص الواجب 
       </textarea>

       <input type="submit" value="  login" name="save" 
           style="font-size:22px; color: black; opacity:0.8;position:relative;width:122px; top:75px;left:-42px;">
 ...
 <footer 
 style="margin-top:439px;height:100px;background:linear-gradient(155deg,#e60073,#6699ff);">
